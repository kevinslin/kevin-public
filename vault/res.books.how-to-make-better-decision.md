...
- keep a decision journal to assess accuracy of decision and avoid [[res.books.how-to-make-better-decision.concepts.hindisght-bias]] and [[res.books.how-to-make-better-decision.concepts.memory-creep]]
- three p's of judging a decision: preference, payoff and probability
- take an outside view/opinion to get beyond own filters
- to overcome analysis paralyss, figure out if you are in a [[res.books.how-to-make-better-decision.concepts.free-roll]] or [[res.books.how-to-make-better-decision.concepts.sheep-in-wolf-clothing-decision]] situation
...
## Concepts
![[res.books.how-to-make-better-decision.concepts.*]]
...
- called outcome bias or [[res.books.how-to-make-better-decision.concepts.resulting]]
...
- [[res.books.how-to-make-better-decision.concepts.hindisght-bias]]: believe event was predictable after it happened #star
- [[res.books.how-to-make-better-decision.concepts.memory-creep]]: when items after outcome makes you feel you knew things all along
...
- [[res.books.how-to-make-better-decision.concepts.decision-forestry]] #star
...
- > Step 1: Identify the reasonable set of possible outcomes
    - > These outcomes can be general scenarios or be focused on particular aspects of the outcomes that you especially care about.
- > Step 2: Identify your preference for each outcometo what degree do you like or dislike each outcome, given your values? 
    - These preferences will be driven by the payoffs associated with each outcome. 
    - Gains comprise the upside and losses comprise the downside. 
    - Include this information in your decision trees.
- > Step 3: Estimate the likelihood of each outcome unfolding. 
    - As a start, use common terms that express probabilities. Don’t be afraid to guess.
...
- [[res.books.how-to-make-better-decision.concepts.free-roll]]: low downside 
- watch out for [[res.books.how-to-make-better-decision.concepts.free-donut]]: lottery ticket 
- [[res.books.how-to-make-better-decision.concepts.sheep-in-wolf-clothing-decision]]: all options are close
...
- [[res.books.how-to-make-better-decision.concepts.behavior-gap]]: what we believe and what we do

- techniques
    - mental contrasting: figure out what might go wrong and what to do
    - [[me.techniques.pre-mortem]]
    - [[res.books.how-to-make-better-decision.concepts.backpath]]: how to succeed
    - pre-commitment, [[res.books.how-to-make-better-decision.concepts.ulysses-contrac]]: heighten or lower barriers to do something
